...
**/
router.post('/register', passport.authenticate('jwt', { session: false }),Middleware.isTrainer,(req, res, next) => {
...
router.post('/new_student', passport.authenticate('jwt', { session: false }),(req, res, next) => {
